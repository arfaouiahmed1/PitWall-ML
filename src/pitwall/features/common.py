...
def add_rolling_features(
    df: pl.DataFrame, group_cols: list[str], value_col: str, windows: list[int] = [3, 5]
) -> pl.DataFrame:
    ...
    for w in windows:
        ...
        # Polars rolling_median doesn't support group_by directly in this version, so do per-group via over
